...
const translations = typeof __ALL_TRANSLATIONS__ !== 'undefined' ? __ALL_TRANSLATIONS__ : {};
...
(function initializeLanguage() {
  ...
  // 确保语言值有效
  const validLanguages = ['zh-CN', 'zh-TW', 'en', 'ja', 'ko', 'es', 'fr', 'de'];
...
async function loadTranslation(lang) {
  ...
  try {
    ...
    console.error('[I18N] ERROR: Failed to load translation:', error.message);
    if (lang !== 'zh-CN') {
