...
func TestValidateAvatarURL(t *testing.T) {
	tests := []struct {
		...
		{"data url png", "data:image/png;base64,iVBORw0KGgoAAAANSUhEUg==", true, ""},
		{"data url bad mime", "data:text/html;base64,AAAA", false, ErrInvalidURL},
		{"data url bad base64", "data:image/png;base64,!!not-base64!!", false, ErrInvalidURL},
